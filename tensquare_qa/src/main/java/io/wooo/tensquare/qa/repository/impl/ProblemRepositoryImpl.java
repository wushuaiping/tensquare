...
public class ProblemRepositoryImpl implements ProblemRepositoryCustom {
    ...
    @Override
    public PageResult<List<Problem>> findByLabelIdAndNewlist(String labelId, Pageable pageable) {
        ...
        final List<Problem> problems = jpaQueryFactory.selectFrom(problem)
                ...
                .fetch();
        final PageResult<List<Problem>> result = new PageResult<>();
    ...
    @Override
    public PageResult<List<Problem>> findByHotlist(String labelId, Pageable pageable) {
        final QProblem problem = QProblem.problem;
        final QReply reply = QReply.reply;
        final List<Problem> problems = jpaQueryFactory.selectFrom(problem)
                .leftJoin(problem.reply, reply)
    ...
    @Override
    public PageResult<List<Problem>> findByWaitlist(String labelId, Pageable pageable) {
        final QProblem problem = QProblem.problem;
        final QReply reply = QReply.reply;
        final List<Problem> problems = jpaQueryFactory.selectFrom(problem)
                .leftJoin(problem.reply, reply)
